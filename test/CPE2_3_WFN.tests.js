...
describe('CPE2_3_WFN.js', function () {
  describe('Grammar', function () {
    ...
    it('should return an error if an attribute is repeated twice', function () {
      const expr = 'wfn:[part="a",vendor="microsoft",product="internet_explorer",version="8\\.0\\.6001",update="beta",edition=NA,update=NA]';
  ...
  describe('#constructor()', function () {
    it('should create a CPE2_3WFN object with a valid string expression', function () {
      // TODO: More examples
      const exprs = [
  ...
  describe('#getAttributeValues()', function () {
    it('should properly extract fields from WFN expressions', function () {
    ...
    it('should return an AttributeError if the attribute name is invalid', function () {
      const expr = 'wfn:[part="a",vendor="microsoft",product="internet_explorer",version="8\\.0\\.6001",update="beta",edition=NA]';
      const cpe = new CPE2_3_WFN(expr);

      chai.expect(() => cpe.getAttributeValues('foo').to.throw(AttributeError));
    });
  });

  describe('#generateWfnStringFromAttributes()', function () {
    it('should create a valid WFN string from an attribute dictionary', function () {
  ...
  describe('#parseWfnString()', function () {
    it('should parse a valid WFN string and turn it into attrs', function () {
      // TODO: Ensure language conditions okay. Hyphen is rejected.
      const expr = 'wfn:[part="a",vendor="b",product="c",version="d",update="e",edition="f",language="en\\-us",sw_edition="h",target_sw="i",target_hw="j",other="k"]';
