...
describe('CPE2_3_FS.js', function () {
  ...
  describe('#constructor()', function () {
    it('should create a CPE2_3FS object with a valid string expression', function () {
      // TODO: More examples
      const exprs = [
  ...
  describe('#getAttributeValues()', function () {
    it('should properly extract fields from FS expressions', function () {
    ...
    it('should return an error if the attribute name is invalid', function () {
      const expr = 'cpe:2.3:a:microsoft:internet_explorer:8.\\*:sp?:*:*:*:*:*:*';
      const cpe = new CPE2_3_FS(expr);
  ...
  describe('#parseCpeString()', function () {
    it('should parse a valid CPE string and turn it into attrs', function () {
      const expr = 'cpe:2.3:a:b:c:d:e:f:*:h:i:j:k';
